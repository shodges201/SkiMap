...
app.get('/status/abasin', (req, res) => {
    ...
    request('https://www.arapahoebasin.com/snow-conditions/terrain/', function (error, response, html) {
        if (!error && response.statusCode == 200) {
            ...
            return res.json({responseString: `${String.fromCharCode(2)}1010101101010110101011010101101010110101010101010110101011010101101010110101011010101010101011010101101010110101011010101101010101010101101010110101011010101101010110101010`});
